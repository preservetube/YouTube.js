...
## [14.0.0](https://github.com/preservetube/YouTube.js/compare/v13.1.0...v14.0.0) (2025-02-25)
...
* replace unnecessary classes with pure functions ([#468](https://github.com/preservetube/YouTube.js/issues/468))
...
* Add `WEB_CREATOR` client ([#757](https://github.com/preservetube/YouTube.js/issues/757)) ([dd7f5cf](https://github.com/preservetube/YouTube.js/commit/dd7f5cf778b8acca95cc6d9c6e379e3e87e0ee8a))
...
* Add support for retrieving transcripts ([#500](https://github.com/preservetube/YouTube.js/issues/500)) ([f94ea6c](https://github.com/preservetube/YouTube.js/commit/f94ea6cf917f63f30dd66514b22a4cf43b948f07))
...
* **Channel:** Add `getPodcasts()` method ([f267fcd](https://github.com/preservetube/YouTube.js/commit/f267fcd8beccf237b8d1924463990273887cae28))
* **Channel:** Add `getReleases()` method ([f267fcd](https://github.com/preservetube/YouTube.js/commit/f267fcd8beccf237b8d1924463990273887cae28))
* **ChannelMetadata:** Add `music_artist_name` ([#497](https://github.com/preservetube/YouTube.js/issues/497)) ([91de6e5](https://github.com/preservetube/YouTube.js/commit/91de6e5c0e5b27e6d12ce5db2f500c5ff78b9830))
...
* **Format:** Populate audio language from captions when available ([#445](https://github.com/preservetube/YouTube.js/issues/445)) ([bdd98a3](https://github.com/preservetube/YouTube.js/commit/bdd98a3b9be39c11942043a300a6ebce9a15efc6))
...
* **FormatUtils:** choose more specific format by itag or codec ([#884](https://github.com/preservetube/YouTube.js/issues/884)) ([1c1577e](https://github.com/preservetube/YouTube.js/commit/1c1577e85fd46cbfa15bcee6531d9aafdda787e5))
...
* **MusicResponsiveListItem:** Detect non music tracks properly ([815e54b](https://github.com/preservetube/YouTube.js/commit/815e54b854fcda3f5423231c8495ce1fb69d8237))
...
* **parser:** Add `AlertWithButton` ([#486](https://github.com/preservetube/YouTube.js/issues/486)) ([8b69587](https://github.com/preservetube/YouTube.js/commit/8b6958778721ba274283f641779fb60bc6f42cd2))
* **parser:** Add `animated_image` to `PageHeaderView` ([#819](https://github.com/preservetube/YouTube.js/issues/819)) ([8e50ebd](https://github.com/preservetube/YouTube.js/commit/8e50ebd92583ae76b080fed4c7599684370dc09d))
...
* **parser:** Add `ChannelHeaderLinksView` ([#484](https://github.com/preservetube/YouTube.js/issues/484)) ([ed7be2a](https://github.com/preservetube/YouTube.js/commit/ed7be2a675cf1ec663e743e90db6260c97546739))
...
* **parser:** Add `CommentsSimplebox` parser ([#442](https://github.com/preservetube/YouTube.js/issues/442)) ([555d257](https://github.com/preservetube/YouTube.js/commit/555d257459b76d7c0158e9c6b189a75a82b10faf))
* **parser:** Add `CompactMovie` ([#487](https://github.com/preservetube/YouTube.js/issues/487)) ([2eed172](https://github.com/preservetube/YouTube.js/commit/2eed1726d5bde7648af09273cc14ab4a315cb23e))
...
* **parser:** Add `HashtagTile` ([#440](https://github.com/preservetube/YouTube.js/issues/440)) ([ae2557d](https://github.com/preservetube/YouTube.js/commit/ae2557d15c9df09bb92e0dc6191670d72b36631a))
...
* **parser:** Add `IncludingResultsFor` ([#447](https://github.com/preservetube/YouTube.js/issues/447)) ([c477b82](https://github.com/preservetube/YouTube.js/commit/c477b824c084552169062f72cde8890e77b31f59))
...
* **parser:** add `MacroMarkersList` ([#444](https://github.com/preservetube/YouTube.js/issues/444)) ([708c5f7](https://github.com/preservetube/YouTube.js/commit/708c5f7394b4ea140836b9483848cb61b97ea1af))
...
* **parser:** add `MusicMultiRowListItem` ([494ee87](https://github.com/preservetube/YouTube.js/commit/494ee8776af0839d3ee2cca3d2fd836680cfdb9e))
...
* **parser:** Add `PageHeader` ([#450](https://github.com/preservetube/YouTube.js/issues/450)) ([18cbc8c](https://github.com/preservetube/YouTube.js/commit/18cbc8c038ddddffa1ba1519e56a8054b2996e42))
...
* **parser:** Add `Quiz` ([#437](https://github.com/preservetube/YouTube.js/issues/437)) ([cffa868](https://github.com/preservetube/YouTube.js/commit/cffa868c6eeb579047653fac65da8e913fb3c621))
* **parser:** Add `ReplaceLiveChatAction` ([#847](https://github.com/preservetube/YouTube.js/issues/847)) ([342fdd1](https://github.com/preservetube/YouTube.js/commit/342fdd1db30bc61de5f19fc4ed35db8931706903))
...
* **parser:** Add `SearchHeader` ([6997982](https://github.com/preservetube/YouTube.js/commit/6997982cf2db87edf4929e9a77e2690e7b630d3d)), closes [#452](https://github.com/preservetube/YouTube.js/issues/452)
...
* **parser:** Add `ShowMiniplayerCommand` ([#443](https://github.com/preservetube/YouTube.js/issues/443)) ([a9cdbf7](https://github.com/preservetube/YouTube.js/commit/a9cdbf7010e7b9b9cfde5db645d51bdad51006c5))
...
* **parser:** Update `LiveChatMembershipItem` ([#836](https://github.com/preservetube/YouTube.js/issues/836)) ([0c319aa](https://github.com/preservetube/YouTube.js/commit/0c319aacdeba106d84b7f44505a7a296a154f97a))
...
* **PlaylistManager:** add .setName() and .setDescription() functions for editing playlists ([#498](https://github.com/preservetube/YouTube.js/issues/498)) ([86fb33e](https://github.com/preservetube/YouTube.js/commit/86fb33ed03a127d9fd4caa695ca97642bffe61bd))
...
* **Session:** Add `IOS` to `ClientType` enum ([22a38c0](https://github.com/preservetube/YouTube.js/commit/22a38c0762499de74f0aeb3ef01332f893518b08))
* **Session:** Add fallback for session data retrieval ([#490](https://github.com/preservetube/YouTube.js/issues/490)) ([10c15bf](https://github.com/preservetube/YouTube.js/commit/10c15bfb9f131a2acea2f26ff3328993d8d8f4aa))
* **Session:** Add on_behalf_of_user session option. ([#494](https://github.com/preservetube/YouTube.js/issues/494)) ([8bc2aaa](https://github.com/preservetube/YouTube.js/commit/8bc2aaa3587fcf79f69eedbc2bf422a4c6fa7eb1))
...
* **SubscribeButton:** Add `unsubscribe_text` ([75b8964](https://github.com/preservetube/YouTube.js/commit/75b89641805abada1498edebac5b72a40860b215))
...
* **toDash:** Add color information ([#430](https://github.com/preservetube/YouTube.js/issues/430)) ([3500e92](https://github.com/preservetube/YouTube.js/commit/3500e926327d560b1db036bfe503c276b91922ac))
* **toDash:** Add option to include thumbnails in the manifest ([#446](https://github.com/preservetube/YouTube.js/issues/446)) ([1a03473](https://github.com/preservetube/YouTube.js/commit/1a034733f6bb641e2d97df12de81ae3516c1f703))
...
* **VideoInfo:** support iOS client ([#467](https://github.com/preservetube/YouTube.js/issues/467)) ([46fe18b](https://github.com/preservetube/YouTube.js/commit/46fe18b763e0c943b24ea10fdf25456ab9ade709))
...
* **YouTube Playlist:** Add subtitle and fix author optionality ([#458](https://github.com/preservetube/YouTube.js/issues/458)) ([0fa5a85](https://github.com/preservetube/YouTube.js/commit/0fa5a859ae15a35266297079e3e34fd9f3a5ebf4))
...
* **BackstagePost:** `vote_button` type mismatch ([fba3fc9](https://github.com/preservetube/YouTube.js/commit/fba3fc971454d66d80d4920fbd60889a221de381))
...
* **CompactMovie:** Add missing import and remove unnecessary console.log ([#496](https://github.com/preservetube/YouTube.js/issues/496)) ([c26972c](https://github.com/preservetube/YouTube.js/commit/c26972c42a6368822ac254c00f1bbee5a1542486))
...
* **Format:** Extracting audio language from captions ([#470](https://github.com/preservetube/YouTube.js/issues/470)) ([31d27b1](https://github.com/preservetube/YouTube.js/commit/31d27b1bca489ee0053d2783f1a956609845a901))
* **Format:** Fix `is_original` always being `true` ([#492](https://github.com/preservetube/YouTube.js/issues/492)) ([0412fa0](https://github.com/preservetube/YouTube.js/commit/0412fa05ff1f00960b398c2f18d5ce39ce0cb864))
...
* incorrect node parser implementations ([#428](https://github.com/preservetube/YouTube.js/issues/428)) ([222dfce](https://github.com/preservetube/YouTube.js/commit/222dfce6bbd13b2cd80ae11540cbc0edd9053fc5))
...
* invalid set ids in dash manifest ([#480](https://github.com/preservetube/YouTube.js/issues/480)) ([1c3ea2a](https://github.com/preservetube/YouTube.js/commit/1c3ea2acd38652c6b40a0817a7836c672a776c4e))
...
* **LockupView:** Add overlay nodes used by `VIDEO` views ([424c653](https://github.com/preservetube/YouTube.js/commit/424c65356c24d19a921e24aadcbbb3cd03ab103a))
...
* **OAuth:** client identity matching ([#421](https://github.com/preservetube/YouTube.js/issues/421)) ([07c1b3e](https://github.com/preservetube/YouTube.js/commit/07c1b3e0e57cb1fa42e4772775bfd1437bbc731f))
* **package:** Bump Jinter to fix bad export order ([#439](https://github.com/preservetube/YouTube.js/issues/439)) ([2aef678](https://github.com/preservetube/YouTube.js/commit/2aef67876ec19118b37d3cecd429ccf8239989e0))
...
* **parser:** Allow any property in the `RawResponse` interface ([3bc53a8](https://github.com/preservetube/YouTube.js/commit/3bc53a8c12e65b22f19a3e337641196b692a94db))
...
* **parser:** Logger logging `classdata` as `[Object object]` ([bf1510b](https://github.com/preservetube/YouTube.js/commit/bf1510b235e3ee7d13d51f092babd1105c3d6b9f))
...
* **Player:** Fix signature algorithm extraction again ([#837](https://github.com/preservetube/YouTube.js/issues/837)) ([13e7961](https://github.com/preservetube/YouTube.js/commit/13e796123b87136f2d5d3b3c9b3ed079a014bf46))
...
* **Playlist:** Add thumbnail_renderer on Playlist when response includes it ([#424](https://github.com/preservetube/YouTube.js/issues/424)) ([4f9427d](https://github.com/preservetube/YouTube.js/commit/4f9427d752e89faec8dd1c4fd7a9607dca998c7a))
...
* **Playlist:** Only try extracting the subtitle for the first page ([#465](https://github.com/preservetube/YouTube.js/issues/465)) ([e370116](https://github.com/preservetube/YouTube.js/commit/e3701160928e9e959b88ca215c6b0a44c70ca6e6))
* **Playlist:** Parse `PlaylistCustomThumbnail` for `thumbnail_renderer` ([f267fcd](https://github.com/preservetube/YouTube.js/commit/f267fcd8beccf237b8d1924463990273887cae28))
...
* **SearchHeader:** remove console.log ([d91695a](https://github.com/preservetube/YouTube.js/commit/d91695a9ec6c55445cbeedba4ace4ac1e0a72eee))
* **SearchSubMenu:** Groups not being parsed due to a typo ([90be877](https://github.com/preservetube/YouTube.js/commit/90be877d28e0ef013056eaeaa4f2765c91addd61))
...
* **StructuredDescriptionContent:** `items` can also be a `HorizontalCardList` ([b50d1ef](https://github.com/preservetube/YouTube.js/commit/b50d1ef67d81276864818de10c61b5a7980cbc1a))
...
* **ThumbnailOverlayResumePlayback:** Update `percent_duration_watched` type ([#737](https://github.com/preservetube/YouTube.js/issues/737)) ([f9ccba4](https://github.com/preservetube/YouTube.js/commit/f9ccba4af5268d67d8610a1a5d623964f56d170d))
...
* **toDash:** Format grouping into AdaptationSets ([#462](https://github.com/preservetube/YouTube.js/issues/462)) ([1ff3e1a](https://github.com/preservetube/YouTube.js/commit/1ff3e1a440389e71055d4b201c29021ca5b39254))
...
* Cache deciphered n-params by info response ([#505](https://github.com/preservetube/YouTube.js/issues/505)) ([d2959b3](https://github.com/preservetube/YouTube.js/commit/d2959b3a55a5081295da4754627913933bbaf1e7))
* Cleanup some unnecessary uses of `YTNode#key` and `Maybe` ([#463](https://github.com/preservetube/YouTube.js/issues/463)) ([0dda97e](https://github.com/preservetube/YouTube.js/commit/0dda97e0b03171de52d7f11a5abf78911e74cead))
...
* **Format:** Cleanup the xtags parsing ([#434](https://github.com/preservetube/YouTube.js/issues/434)) ([1ca2083](https://github.com/preservetube/YouTube.js/commit/1ca20836bf343c78461fab7ad3b71db2b96e65c3))
...
* **generator:** Remove duplicate checks in `isMiscType` ([#506](https://github.com/preservetube/YouTube.js/issues/506)) ([68df321](https://github.com/preservetube/YouTube.js/commit/68df3218580db10c9a0932c93ff2ce487526ff1e))
...
* **toDash:** Hoist duplicates from Representation to AdaptationSet ([#431](https://github.com/preservetube/YouTube.js/issues/431)) ([5f058e6](https://github.com/preservetube/YouTube.js/commit/5f058e69ae8594491133f7f96287bea4137f7822))
...
* replace unnecessary classes with pure functions ([#468](https://github.com/preservetube/YouTube.js/issues/468)) ([87ed396](https://github.com/preservetube/YouTube.js/commit/87ed3960ffa1c738b6f3b5acaf423647db4d367e))
